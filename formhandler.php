...
$subject = 'Submission from Survey1'; // if your client has more than one web site, you can put the site name here.
...
mail ('kaelavin@gmail.com', $subject, $body, $from);

header('Location: survey1thanks.php'); // replace "thx.html" with the name and path to your actual thank you page